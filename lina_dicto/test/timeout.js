...
it ("Dictionary.query_index_from_incremental_keyword timeout", function(done) {
	...
	const EO_TO_JA_DICT_DATAS = [
		...
		['voc^a',		{'isMatch':true}],
		['voc^o',		{'isMatch':true}],
		["au^tomobilkompanio",		{'isMatch':true}], // 長い語(約17文字以上)
		['ekstremmaldekstrulo',		{'isMatch':true}],
		["elektrodinamometro",		{'isMatch':true}],
		["elektrokardiografi",		{'isMatch':true}],
		['elektrokardiografio',		{'isMatch':true}],
		["elektrokardiografo",		{'isMatch':true}],
		["elektrokardiogramo",		{'isMatch':true}],
		['otorinolaringologio',		{'isMatch':true}],
		['kontrau^konstitucia',		{'isMatch':true}],
		['kontrau^militarismo',		{'isMatch':true}],
		['kontrau^militaristo',		{'isMatch':true}],
		['kontrau^s^rau^bingo',		{'isMatch':true}],
		['kontrau^torpeds^ipo',		{'isMatch':true}],
		["maksimumtermometro",		{'isMatch':true}],
		["potencialdiferenco",		{'isMatch':true}],
		["socialdemokratismo",		{'isMatch':true}],
		["transsubstancigado",		{'isMatch':true}],
		// ----
		['bon',			{'isMatch':true}],
		['bona',		{'isMatch':true}],
		...
		['voc^',		{'isMatch':true}],
		['voc^',		{'isMatch':true}],
		["au^tomobilkompani",		{'isMatch':true}],
		['ekstremmaldekstrul',		{'isMatch':true}],
		["elektrodinamometr",		{'isMatch':true}],
		["elektrokardiograf",		{'isMatch':true}],
		['elektrokardiografi',		{'isMatch':true}],
		["elektrokardiograf",		{'isMatch':true}],
		["elektrokardiogram",		{'isMatch':true}],
		['otorinolaringologi',		{'isMatch':true}],
		['kontrau^konstituci',		{'isMatch':true}],
		['kontrau^militarism',		{'isMatch':true}],
		['kontrau^militarist',		{'isMatch':true}],
		['kontrau^s^rau^bing',		{'isMatch':true}],
		['kontrau^torpeds^ip',		{'isMatch':true}],
		["maksimumtermometr",		{'isMatch':true}],
		["potencialdiferenc",		{'isMatch':true}],
		["socialdemokratism",		{'isMatch':true}],
		["transsubstancigad",		{'isMatch':true}],
		// ----
		['vocxa',		{'isMatch':false}],
		['vocxo',		{'isMatch':false}],
		['bocxa',		{'isMatch':false}],
